...
import { safeStorage } from './utils/browser-compatibility';
...
const App = () => {
  ...
  useEffect(() => {
    try {
      ...
      // Use safeStorage utility for cross-browser compatibility
      const hasSeenWelcome = safeStorage.getItem("hasSeenWelcome");
