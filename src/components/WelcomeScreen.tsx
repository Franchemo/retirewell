      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-between py-20 px-6 text-center">
        ...
        >
          <motion.div
            ...
            className="w-24 h-24 mx-auto mb-8 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center"
          >
        ...
        >
          <motion.button
            onClick={handleContinue}
            className="w-full h-14 bg-white rounded-xl text-[#4B4E8E] font-medium shadow-lg shadow-black/30 hover:shadow-xl hover:shadow-black/40 transition-all duration-300"
